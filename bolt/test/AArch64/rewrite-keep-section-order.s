...
// RUN: llvm-readelf -S %t.kso 2>&1 | FileCheck %s --check-prefix=CHECK-KSO
...
## Upstream emits .eh_frame_hdr before .eh_frame in the section header table
## for elfutils/libdw compatibility, so assert that order here.
// CHECK-KSO: .foo.ro
// CHECK-KSO: .bar.ro
