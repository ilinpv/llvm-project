...
# RUN: bash -c "D=$(llvm-readelf -SW %t.bolt | awk '$3==\".data\" {print $5}'); V=$(( 0x$D )); W=$(printf '%02x%02x%02x%02x 00000000' $(( V & 0xff )) $(( (V>>8) & 0xff )) $(( (V>>16) & 0xff )) $(( (V>>24) & 0xff ))); llvm-readelf -x .got %t.bolt | grep -q \"$W\""
